...
using VNRPG.messages.jobs;
using VNRPG.messages.items;
using VNRPG.messages.description;
using System.Collections.Generic;

namespace VNRPG.globals
{
    public class Constants
    {
        ...
        {  
            ...
            new UniformModel(0, FACTION_SHERIFF, SEX_MALE, 2, -1, -1),
            ...
            new UniformModel(0, FACTION_SHERIFF, SEX_FEMALE, 2, -1, -1),
        ...
        public static List<BusinessClothesModel> BUSINESS_CLOTHES_LIST = new List<BusinessClothesModel>
        {
            ...
            // Female pants
            new BusinessClothesModel(0, "vaqueros estrechos oscuros", CLOTHES_LEGS, 0, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "vaqueros anchos oscuros", CLOTHES_LEGS, 1, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "deportivo recogido blanco", CLOTHES_LEGS, 2, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal negro cinturon blanco", CLOTHES_LEGS, 3, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "vaquero pirata oscuro", CLOTHES_LEGS, 4, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "corto a cuadros", CLOTHES_LEGS, 5, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal negro", CLOTHES_LEGS, 6, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "falda negra", CLOTHES_LEGS, 7, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "minifalda negra", CLOTHES_LEGS, 8, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "minifalda negra con motivos", CLOTHES_LEGS, 9, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "deportivo corto blanco y celeste", CLOTHES_LEGS, 10, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "vaquero pirata marron", CLOTHES_LEGS, 11, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "minifalda volantes a cuadros", CLOTHES_LEGS, 12, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "corto gris", CLOTHES_LEGS, 14, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "bikini negro", CLOTHES_LEGS, 15, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "corto amarillo", CLOTHES_LEGS, 16, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "bikini blanco", CLOTHES_LEGS, 17, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "falda roja", CLOTHES_LEGS, 18, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "interior encaje blanca", CLOTHES_LEGS, 19, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "interior encaje blanca con liguero y media", CLOTHES_LEGS, 20, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "bikini rojo", CLOTHES_LEGS, 21, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "recto blanco", CLOTHES_LEGS, 23, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "falda comic", CLOTHES_LEGS, 24, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "corto vaquero", CLOTHES_LEGS, 25, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "minifalda leopardo", CLOTHES_LEGS, 26, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "latex negro", CLOTHES_LEGS, 27, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "minifalda rayas roja y blanca", CLOTHES_LEGS, 28, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "ancho con agarres marron", CLOTHES_LEGS, 29, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal pirata negro", CLOTHES_LEGS, 30, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "leggins rojo", CLOTHES_LEGS, 31, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "ancho negro con rodilleras", CLOTHES_LEGS, 33, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal negro hebilla dorada", CLOTHES_LEGS, 34, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "ancho verde con reflectante", CLOTHES_LEGS, 35, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "falda gris", CLOTHES_LEGS, 36, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal negro", CLOTHES_LEGS, 37, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "ancho rojo", CLOTHES_LEGS, 38, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "ancho marron cinturon oscuro", CLOTHES_LEGS, 41, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "ancho con agarres negro", CLOTHES_LEGS, 42, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "vaquero negro roto frontal", CLOTHES_LEGS, 43, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "vaquero negro roto lateral", CLOTHES_LEGS, 44, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "ancho verde militar", CLOTHES_LEGS, 45, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal negro", CLOTHES_LEGS, 47, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "ancho marron rodilleras cinturon negro", CLOTHES_LEGS, 48, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal marron cinturon negro", CLOTHES_LEGS, 49, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "recto blanco", CLOTHES_LEGS, 50, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "leggins blanco", CLOTHES_LEGS, 51, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "recto rojo oscuro", CLOTHES_LEGS, 52, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal oscuro con flores marrones", CLOTHES_LEGS, 53, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "leggins rojo oscuro", CLOTHES_LEGS, 54, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "leggins oscuro con flores marrones", CLOTHES_LEGS, 55, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "bikini rosa", CLOTHES_LEGS, 56, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "falda blanca con lazo", CLOTHES_LEGS, 57, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "chandal negro rayas blancas lateral", CLOTHES_LEGS, 58, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal a cuadros rojo", CLOTHES_LEGS, 60, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "culotte encaje blanco y negro", CLOTHES_LEGS, 62, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "interior blanco y legro con liguero y medias", CLOTHES_LEGS, 63, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal camel", CLOTHES_LEGS, 64, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "chandal azul rayas blancas lateral", CLOTHES_LEGS, 66, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal blanco con rayas grises", CLOTHES_LEGS, 67, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "chandal negro y blanco", CLOTHES_LEGS, 68, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "ancho negro con calaveras blancas", CLOTHES_LEGS, 71, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "vaquero pegado oscuro", CLOTHES_LEGS, 73, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "vaquero rasgado oscuro", CLOTHES_LEGS, 74, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "vaquero pegado negro", CLOTHES_LEGS, 75, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "short vaquero con medias oscuras", CLOTHES_LEGS, 78, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "chandal marron oscuro", CLOTHES_LEGS, 80, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "chandal negro", CLOTHES_LEGS, 81, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "chandal pirata marron oscuro", CLOTHES_LEGS, 82, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "chandal pirata negro", CLOTHES_LEGS, 83, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "vaquero bajos negro", CLOTHES_LEGS, 84, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "normal bajos negro", CLOTHES_LEGS, 85, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "leggins militar oscuro y rojo", CLOTHES_LEGS, 87, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "leggins rayas colores fosforitos", CLOTHES_LEGS, 88, SEX_FEMALE, 50),
            ...
            // Male shoes
            new BusinessClothesModel(0, "Zapatillas cuadros negros y blancos tobillo alto", CLOTHES_FEET, 0, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas negra suela blanca", CLOTHES_FEET, 1, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas cuadros negros y blancos tobillo bajo", CLOTHES_FEET, 2, SEX_MALE, 50),
            new BusinessClothesModel(0, "Normal marron oscuro y gris", CLOTHES_FEET, 3, SEX_MALE, 50),
            new BusinessClothesModel(0, "Converse azul oscuro tobillo alto", CLOTHES_FEET, 4, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chanclas negra y blanca", CLOTHES_FEET, 5, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chanclas negras calcetines blancos", CLOTHES_FEET, 6, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas blancas calcetines altos", CLOTHES_FEET, 7, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas blancas marca calcetines altos", CLOTHES_FEET, 9, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatos negros punta calcetines altos", CLOTHES_FEET, 10, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas planas cuadros negros y blancos", CLOTHES_FEET, 11, SEX_MALE, 50),
            new BusinessClothesModel(0, "Botas marron", CLOTHES_FEET, 12, SEX_MALE, 50),
            new BusinessClothesModel(0, "Botas oscuras suela blanca", CLOTHES_FEET, 14, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota negra lisa punta", CLOTHES_FEET, 15, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chanclas negra", CLOTHES_FEET, 16, SEX_MALE, 50),
            new BusinessClothesModel(0, "Duende verde", CLOTHES_FEET, 17, SEX_MALE, 50),
            new BusinessClothesModel(0, "Normal blanco y negro calcetin alto", CLOTHES_FEET, 18, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapato blanco y negro botones negros", CLOTHES_FEET, 19, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapato marron oscuro punta calcetines altos", CLOTHES_FEET, 20, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapato marron oscuro punta calcetin bajo", CLOTHES_FEET, 21, SEX_MALE, 50),
            new BusinessClothesModel(0, "Converse azul tobillo alto", CLOTHES_FEET, 22, SEX_MALE, 50),
            new BusinessClothesModel(0, "Normal marron suela amarilla", CLOTHES_FEET, 23, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota negra", CLOTHES_FEET, 24, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota negra tachuelas", CLOTHES_FEET, 25, SEX_MALE, 50),
            new BusinessClothesModel(0, "Converse azul oscuro tobillo alto", CLOTHES_FEET, 26, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas blanca puntos negros tobillo alto", CLOTHES_FEET, 28, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas dorado tobillo alto", CLOTHES_FEET, 29, SEX_MALE, 50),
            new BusinessClothesModel(0, "Normal blanco y oscuro hebilla", CLOTHES_FEET, 30, SEX_MALE, 50),
            new BusinessClothesModel(0, "Deportivas amarillo gris blanco negro", CLOTHES_FEET, 31, SEX_MALE, 50),
            new BusinessClothesModel(0, "Deportivas negro y blanco", CLOTHES_FEET, 32, SEX_MALE, 50),
            new BusinessClothesModel(0, "Descalzo", CLOTHES_FEET, 34, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota marron tobillo alto", CLOTHES_FEET, 35, SEX_MALE, 50),
            new BusinessClothesModel(0, "Normal marron oscuro hebilla dorada", CLOTHES_FEET, 36, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota cowboy alta punta", CLOTHES_FEET, 37, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota cowboy baja punta", CLOTHES_FEET, 38, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapato azul y gris calcetin alto", CLOTHES_FEET, 40, SEX_MALE, 50),
            new BusinessClothesModel(0, "Pantufla rojo oscuro y negro", CLOTHES_FEET, 41, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas grisaceo", CLOTHES_FEET, 42, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota baja amarillo", CLOTHES_FEET, 43, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota cowboy alta azul punta", CLOTHES_FEET, 44, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota cowboy baja azul punta", CLOTHES_FEET, 45, SEX_MALE, 50),
            new BusinessClothesModel(0, "Deportivas blanca y azul", CLOTHES_FEET, 46, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota alta verde y blanca", CLOTHES_FEET, 47, SEX_MALE, 50),
            new BusinessClothesModel(0, "Converse negro y blanco tobillo alto", CLOTHES_FEET, 48, SEX_MALE, 50),
            new BusinessClothesModel(0, "Converse amarillo y blanco tobillo alto", CLOTHES_FEET, 49, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota tobillo algo negra", CLOTHES_FEET, 50, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatos bajos negro", CLOTHES_FEET, 51, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota redonda marron", CLOTHES_FEET, 52, SEX_MALE, 50),
            new BusinessClothesModel(0, "Bota negra tobillo alto tachuelas", CLOTHES_FEET, 53, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapato negro tobillo bajo tachuelas", CLOTHES_FEET, 54, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas negras rayas amarillo fosforito", CLOTHES_FEET, 55, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapato marron tobillo bajo suela negra", CLOTHES_FEET, 56, SEX_MALE, 50),
            new BusinessClothesModel(0, "Zapatillas camel", CLOTHES_FEET, 57, SEX_MALE, 50),
            new BusinessClothesModel(0, "Plano negro rayas rojas y celestes", CLOTHES_FEET, 58, SEX_MALE, 50),
            ...
            // Female torsos
            new BusinessClothesModel(0, "Guantes largos morado", CLOTHES_TORSO, 16, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Guantes verde", CLOTHES_TORSO, 17, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Guantes negro", CLOTHES_TORSO, 45, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Guantes negros dedos fuera", CLOTHES_TORSO, 71, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Guantes negros exterior", CLOTHES_TORSO, 31, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Guantes amarillo y blanco", CLOTHES_TORSO, 84, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Guantes blancos", CLOTHES_TORSO, 97, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Guantes celeste", CLOTHES_TORSO, 110, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Guantes verde oscuro", CLOTHES_TORSO, 126, SEX_FEMALE, 50),
            ...
            new BusinessClothesModel(0, "Sin guantes 8", CLOTHES_TORSO, 10, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sin guantes 9", CLOTHES_TORSO, 12, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sin guantes 10", CLOTHES_TORSO, 13, SEX_FEMALE, 50),
            ...
            // Male torsos
            new BusinessClothesModel(0, "Guantes verde", CLOTHES_TORSO, 16, SEX_MALE, 50),
            new BusinessClothesModel(0, "Guantes negro", CLOTHES_TORSO, 17, SEX_MALE, 50),
            new BusinessClothesModel(0, "Guantes negro dedos fuera", CLOTHES_TORSO, 18, SEX_MALE, 50),
            new BusinessClothesModel(0, "Guantes negros exterior", CLOTHES_TORSO, 19, SEX_MALE, 50),
            new BusinessClothesModel(0, "Guantes negros basicos", CLOTHES_TORSO, 30, SEX_MALE, 50),
            ...
            new BusinessClothesModel(0, "Guantes celestes", CLOTHES_TORSO, 121, SEX_MALE, 50),
            new BusinessClothesModel(0, "Guantes negros altos", CLOTHES_TORSO, 96, SEX_MALE, 50),
            new BusinessClothesModel(0, "Guantes verde oscuro", CLOTHES_TORSO, 99, SEX_MALE, 50),
            ...
            new BusinessClothesModel(0, "Sin guantes", CLOTHES_TORSO, 0, SEX_MALE, 50),
            ...
            // Female tops
            new BusinessClothesModel(0, "Camiseta manga corta rojo oscuro y gris", CLOTHES_TOPS, 0, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta vaquera remangada abierta", CLOTHES_TOPS, 1, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca hombro al aire", CLOTHES_TOPS, 2, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera blanca", CLOTHES_TOPS, 3, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantes cuadros negro y blanco", CLOTHES_TOPS, 4, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Top blanco", CLOTHES_TOPS, 5, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra y blanca remangada", CLOTHES_TOPS, 6, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 7, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta gris remangada abierta", CLOTHES_TOPS, 8, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa negra", CLOTHES_TOPS, 9, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera negra rayas morado y blanco", CLOTHES_TOPS, 10, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantes celeste negra y blanca", CLOTHES_TOPS, 11, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantes cuadros negro y blanco", CLOTHES_TOPS, 12, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Palabra de honor negro", CLOTHES_TOPS, 13, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Polo lacoste blanco", CLOTHES_TOPS, 14, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Bikini negro", CLOTHES_TOPS, 15, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantes roja", CLOTHES_TOPS, 16, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa hawaiana", CLOTHES_TOPS, 17, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Bikini blanco", CLOTHES_TOPS, 18, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta mama noel", CLOTHES_TOPS, 19, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta roja y blanca remangada", CLOTHES_TOPS, 20, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Vestido volantes de morado a blanco", CLOTHES_TOPS, 21, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Palabra de honor blanco encaje", CLOTHES_TOPS, 22, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca", CLOTHES_TOPS, 23, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta blanca y negra remangada", CLOTHES_TOPS, 24, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta roja abierta", CLOTHES_TOPS, 25, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantes griega camel", CLOTHES_TOPS, 26, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa blanca por dentro de pantalon", CLOTHES_TOPS, 27, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaquetilla gris tirantes", CLOTHES_TOPS, 28, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta azul y negra abierta remangada", CLOTHES_TOPS, 31, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantes leopardo", CLOTHES_TOPS, 32, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Top blanco rayas negras", CLOTHES_TOPS, 33, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta camuflaje abierta", CLOTHES_TOPS, 34, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta corta amarilla y blanca remangada", CLOTHES_TOPS, 35, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantes negra FIST", CLOTHES_TOPS, 36, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Vestido flores rosas", CLOTHES_TOPS, 37, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta verde hombro fuera", CLOTHES_TOPS, 38, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga EEUU", CLOTHES_TOPS, 39, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga mama noel", CLOTHES_TOPS, 40, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta azul hombro fuera", CLOTHES_TOPS, 41, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta militar enganches verde", CLOTHES_TOPS, 42, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga rojo y blanco", CLOTHES_TOPS, 45, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta militar enganches negra", CLOTHES_TOPS, 47, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta gris", CLOTHES_TOPS, 49, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera negra cuello ancho", CLOTHES_TOPS, 50, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta gris abierta", CLOTHES_TOPS, 52, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta gris remangada", CLOTHES_TOPS, 53, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron", CLOTHES_TOPS, 54, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero negro", CLOTHES_TOPS, 55, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa negra manga corta", CLOTHES_TOPS, 56, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 57, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra cerrada ", CLOTHES_TOPS, 58, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta rota", CLOTHES_TOPS, 59, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta rota roja y negra manga larga", CLOTHES_TOPS, 60, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga gris", CLOTHES_TOPS, 61, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra con capucha puesta", CLOTHES_TOPS, 62, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra con capucha quitada", CLOTHES_TOPS, 63, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta larga veig abierta", CLOTHES_TOPS, 64, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta roja con pelitos en cuello maron", CLOTHES_TOPS, 65, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa negra escotada hombreras", CLOTHES_TOPS, 66, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta amarilla hombro fuera", CLOTHES_TOPS, 67, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta tonos amarillos naranja y marron", CLOTHES_TOPS, 68, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra con hebillas", CLOTHES_TOPS, 69, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta veig cerrada por cinturon", CLOTHES_TOPS, 70, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa cuadritos veig, amarillo, marron y negro remangada", CLOTHES_TOPS, 71, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera roja y blanca W", CLOTHES_TOPS, 72, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca por dentro del pantalon", CLOTHES_TOPS, 73, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Top blanco poco ajustado", CLOTHES_TOPS, 74, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta amarilla y negra por dentro del pantalon", CLOTHES_TOPS, 75, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa larga gris y rayas amarillas", CLOTHES_TOPS, 76, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa larga negra", CLOTHES_TOPS, 77, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera negra capucha", CLOTHES_TOPS, 78, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Jersey negro", CLOTHES_TOPS, 79, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta rojo oscuro y blanco sin letra", CLOTHES_TOPS, 80, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta rojo y blanco P", CLOTHES_TOPS, 81, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa negra sencilla", CLOTHES_TOPS, 83, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS", CLOTHES_TOPS, 84, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS por dentro del pantalon", CLOTHES_TOPS, 85, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa vaquera por dentro del pantalon", CLOTHES_TOPS, 86, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera azul con franja blanca F", CLOTHES_TOPS, 87, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta marron", CLOTHES_TOPS, 88, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron por dentro del pantalon", CLOTHES_TOPS, 89, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta blanca abierta", CLOTHES_TOPS, 90, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta blanca cerrada", CLOTHES_TOPS, 91, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta roja abierta", CLOTHES_TOPS, 92, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta roja cerrada", CLOTHES_TOPS, 93, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta oscura con flores marrones abierta", CLOTHES_TOPS, 94, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta oscura con flores marrones cerrada", CLOTHES_TOPS, 95, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa blanca con flores", CLOTHES_TOPS, 96, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta larga azul oscuro", CLOTHES_TOPS, 97, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa blanca cerrada con bolsillos grandes", CLOTHES_TOPS, 98, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta roja y negra larga", CLOTHES_TOPS, 99, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca sin mangas", CLOTHES_TOPS, 100, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Bikini rosa", CLOTHES_TOPS, 101, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron oscuro larga cerrada", CLOTHES_TOPS, 102, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro del pantalon", CLOTHES_TOPS, 103, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron claro cerrada", CLOTHES_TOPS, 104, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa blanca ombligo fuera", CLOTHES_TOPS, 105, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera roja blanca y negra", CLOTHES_TOPS, 106, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Gabardina negra abierta", CLOTHES_TOPS, 107, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Mama noel sucio", CLOTHES_TOPS, 108, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa cerrada roja y negra", CLOTHES_TOPS, 109, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero negra y verde", CLOTHES_TOPS, 110, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Palabra de honor marron y blanco", CLOTHES_TOPS, 111, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Vestido azul y negro", CLOTHES_TOPS, 112, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Vestido marron y negro", CLOTHES_TOPS, 113, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Vestido rojo y dorado", CLOTHES_TOPS, 114, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Vestido verde oscuro y amarillo", CLOTHES_TOPS, 115, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Vestido blanco y gris", CLOTHES_TOPS, 116, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca sin manga por dentro del pantalon", CLOTHES_TOPS, 117, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca sin manga", CLOTHES_TOPS, 118, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Polo blanco grande", CLOTHES_TOPS, 119, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa de cuadros negro y azulado abierto", CLOTHES_TOPS, 120, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa de cuadros negro y azulado cerrado", CLOTHES_TOPS, 121, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta camel cerrada larga", CLOTHES_TOPS, 122, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta rayas negras y blancas", CLOTHES_TOPS, 123, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta larga verde", CLOTHES_TOPS, 125, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta negra larga", CLOTHES_TOPS, 126, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra triangulo rojo y blanco", CLOTHES_TOPS, 127, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Polo azul LIBERTY", CLOTHES_TOPS, 128, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Polo azul LIBERTY por dentro de pantalones", CLOTHES_TOPS, 129, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Polo blanco y gris remangado", CLOTHES_TOPS, 130, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera negra LIBERTY con capucha", CLOTHES_TOPS, 131, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa remangada negra flores amarillas", CLOTHES_TOPS, 132, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta larga abierta gris oscuro", CLOTHES_TOPS, 133, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Jersey sin mangas rombos negros gris y blanco", CLOTHES_TOPS, 134, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron oscuro con cinturon", CLOTHES_TOPS, 135, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro de pantalones", CLOTHES_TOPS, 136, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta azul larga escotada", CLOTHES_TOPS, 137, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera azul con franjas blancas", CLOTHES_TOPS, 138, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta larga abierta negra", CLOTHES_TOPS, 139, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera verde y blanca", CLOTHES_TOPS, 140, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta celeste", CLOTHES_TOPS, 141, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa celeste manga larga", CLOTHES_TOPS, 142, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta celeste cerrada", CLOTHES_TOPS, 143, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera azul y blanca cerrada", CLOTHES_TOPS, 144, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta verde y blanca", CLOTHES_TOPS, 145, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta veig y EEUU", CLOTHES_TOPS, 146, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra y amarilla", CLOTHES_TOPS, 147, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa abierta oscura con letras amarillas", CLOTHES_TOPS, 148, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta NAGASAK rosa", CLOTHES_TOPS, 149, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera negra y roja", CLOTHES_TOPS, 150, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera marron italia", CLOTHES_TOPS, 151, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta amarilla EEUU", CLOTHES_TOPS, 152, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaquetilla negra abierta sin mangas", CLOTHES_TOPS, 154, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaquetilla sin mangas negra con cremallera", CLOTHES_TOPS, 155, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaquetilla negra sin mangas con botones", CLOTHES_TOPS, 156, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaquetilla negra sin mangas abierta cremallera", CLOTHES_TOPS, 157, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta de cuero negra cerrada", CLOTHES_TOPS, 158, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta de cuero negra sin mangas cerrada", CLOTHES_TOPS, 159, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa cuero negro abierto", CLOTHES_TOPS, 160, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa larga cuero negro media manga", CLOTHES_TOPS, 161, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta azul oscuro manga serpiente blanco", CLOTHES_TOPS, 162, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero negra abierta", CLOTHES_TOPS, 163, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Abrigo rojo michelin", CLOTHES_TOPS, 164, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta oliva", CLOTHES_TOPS, 165, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa vaquera abierta", CLOTHES_TOPS, 166, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa vaquera abierta sin mangas", CLOTHES_TOPS, 167, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta corta sin mangas negra", CLOTHES_TOPS, 168, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta corta negra", CLOTHES_TOPS, 169, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Top negro suelto", CLOTHES_TOPS, 170, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa vaquera recogida", CLOTHES_TOPS, 171, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Abrigo negro capucha", CLOTHES_TOPS, 172, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaquetilla tirantes pinguino", CLOTHES_TOPS, 173, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta vaquera pegatinas abierta", CLOTHES_TOPS, 174, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta vaquera sin mangas pegatina abierta", CLOTHES_TOPS, 175, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero negra pegatinas cerrada", CLOTHES_TOPS, 176, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero negra pegatinas sin mangas", CLOTHES_TOPS, 177, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa sin mangas negra pegatinas", CLOTHES_TOPS, 178, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta sin mangas azul oscuro", CLOTHES_TOPS, 179, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga negra con rayas amarillas", CLOTHES_TOPS, 180, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa rayas blancas y negras", CLOTHES_TOPS, 185, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chubasquero verde largo con capucha", CLOTHES_TOPS, 186, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chubasquero verde largo con capucha abierto", CLOTHES_TOPS, 187, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Gabardina negra larga", CLOTHES_TOPS, 189, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chubasquero camel con capucha", CLOTHES_TOPS, 190, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chubasquero largo con capucha camel", CLOTHES_TOPS, 191, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Jersey gris con rombos negros recogido", CLOTHES_TOPS, 192, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta verde camuflaje y negra abierta", CLOTHES_TOPS, 193, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Gabardina gris larga abierta", CLOTHES_TOPS, 194, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta recogida negra letras rosas", CLOTHES_TOPS, 195, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Jersey navideño", CLOTHES_TOPS, 196, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Jersey remangado gris con bits amarillos", CLOTHES_TOPS, 198, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa azul arboles blancos", CLOTHES_TOPS, 200, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera amarilla parches naranjas", CLOTHES_TOPS, 202, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta ajustada negra con rayas amarillas celestes verdes y rosa", CLOTHES_TOPS, 203, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta sin manga negra con capucha puesta", CLOTHES_TOPS, 204, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera amarilla parches naranjas con capucha puesta", CLOTHES_TOPS, 205, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Gabardina negra con capucha puesta", CLOTHES_TOPS, 206, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta sin mangas negra con cuello ancho", CLOTHES_TOPS, 207, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje sin mangas por dentro del pantalon", CLOTHES_TOPS, 208, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje sin mangas", CLOTHES_TOPS, 209, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado sin mangas con capucha", CLOTHES_TOPS, 210, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado sin mangas capucha puesta", CLOTHES_TOPS, 211, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado metida por pantalon", CLOTHES_TOPS, 212, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chubasquero camuflaje azulado con capucha", CLOTHES_TOPS, 214, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chubasquero camuflaje azulado con capucha puesta", CLOTHES_TOPS, 215, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chubasquero camuflaje azulado abierto", CLOTHES_TOPS, 216, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta sin mangas negro y camuflaje azulado", CLOTHES_TOPS, 217, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga negra con camuflaje azulado", CLOTHES_TOPS, 218, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado y negro abierta", CLOTHES_TOPS, 219, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado y negro sin mangas abierta", CLOTHES_TOPS, 220, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado sin mangas recogido ", CLOTHES_TOPS, 221, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado recogido", CLOTHES_TOPS, 222, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Top suelto camuflaje azulado", CLOTHES_TOPS, 223, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado por dentro del pantalon", CLOTHES_TOPS, 224, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta sin mangas camuflaje azulado", CLOTHES_TOPS, 225, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta sin mangas camuflaje azulado metido por pantalon", CLOTHES_TOPS, 226, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chubasquero marron largo cerrado", CLOTHES_TOPS, 227, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chubasquero marron largo cerrado capucha puesta", CLOTHES_TOPS, 228, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaquetilla camuflaje azulado sin manga", CLOTHES_TOPS, 229, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Sudadera azul y camuflaje azulado mangas largas", CLOTHES_TOPS, 230, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta mangas largas camuflaje azulado", CLOTHES_TOPS, 231, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camisa camuflaje azulado", CLOTHES_TOPS, 232, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta sin mangas cerrada por cremallera negra", CLOTHES_TOPS, 233, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra con mangas largas cerrada con cremallera", CLOTHES_TOPS, 234, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca y mangas azules con letras", CLOTHES_TOPS, 235, SEX_FEMALE, 50),
            new BusinessClothesModel(0, "Camiseta negra normal", CLOTHES_TOPS, 236, SEX_FEMALE, 50),
            
            // Male tops
            new BusinessClothesModel(0, "Camiseta roja mangas gris", CLOTHES_TOPS, 0, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca", CLOTHES_TOPS, 1, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta sin mangas cuadros negro y blanco", CLOTHES_TOPS, 2, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa abierta blanca", CLOTHES_TOPS, 3, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa abierta negra", CLOTHES_TOPS, 4, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantes blanca", CLOTHES_TOPS, 5, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera abierta negra con rayas blancas", CLOTHES_TOPS, 6, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera abierta blanca", CLOTHES_TOPS, 7, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga remangada azul y rojo", CLOTHES_TOPS, 8, SEX_MALE, 50),
            new BusinessClothesModel(0, "Polo blanco y negro con rayas negras", CLOTHES_TOPS, 9, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta escotada negra", CLOTHES_TOPS, 10, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaquetilla cerrada gris", CLOTHES_TOPS, 11, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa blanca", CLOTHES_TOPS, 12, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa blanca por dentro del pantalon", CLOTHES_TOPS, 13, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa azul cuadrados azul y blanca", CLOTHES_TOPS, 14, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sin camiseta", CLOTHES_TOPS, 15, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta gris", CLOTHES_TOPS, 16, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantes azul", CLOTHES_TOPS, 17, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta papa noel", CLOTHES_TOPS, 18, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta roja y blanca escote", CLOTHES_TOPS, 19, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta blanca pañuelo rojo", CLOTHES_TOPS, 20, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaquetilla gris claro sin mangas", CLOTHES_TOPS, 21, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca basica", CLOTHES_TOPS, 22, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta oliva abierta", CLOTHES_TOPS, 23, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta gris claro escote", CLOTHES_TOPS, 24, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaquetilla amarilla sin mangas", CLOTHES_TOPS, 25, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa negra remangada dentro del pantalon", CLOTHES_TOPS, 26, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta larga negra", CLOTHES_TOPS, 27, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta larga negra escote", CLOTHES_TOPS, 28, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta larga negra abierta", CLOTHES_TOPS, 29, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta rayas blanca y gris", CLOTHES_TOPS, 33, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta negra basica", CLOTHES_TOPS, 34, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta abierta negra rayas blancas", CLOTHES_TOPS, 35, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta tirantas blanco gris negro y azul", CLOTHES_TOPS, 36, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron y camel", CLOTHES_TOPS, 37, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta remangada gris y negra", CLOTHES_TOPS, 38, SEX_MALE, 50),
            new BusinessClothesModel(0, "Polo rojo azul y blanco", CLOTHES_TOPS, 39, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaquetilla sin mangas roja", CLOTHES_TOPS, 40, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa cuadros camel marron naranja", CLOTHES_TOPS, 41, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa remangada azul tirantes", CLOTHES_TOPS, 42, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta verde lima", CLOTHES_TOPS, 44, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta sin manga EEUU", CLOTHES_TOPS, 45, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta abierta azul roja y blanca", CLOTHES_TOPS, 46, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta azul basica", CLOTHES_TOPS, 47, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera bolsillos verde enganches", CLOTHES_TOPS, 48, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera negra", CLOTHES_TOPS, 49, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga papa noel", CLOTHES_TOPS, 51, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga roja y blanca", CLOTHES_TOPS, 52, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga negra por dentro del pantalon", CLOTHES_TOPS, 53, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera bolsillos negra enganches", CLOTHES_TOPS, 54, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca sucia", CLOTHES_TOPS, 56, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera gris con capucha", CLOTHES_TOPS, 57, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 58, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta gris larga abierta", CLOTHES_TOPS, 59, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta gris larga escote", CLOTHES_TOPS, 60, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera marron cerrada cremallera", CLOTHES_TOPS, 61, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra larga abierta", CLOTHES_TOPS, 62, SEX_MALE, 50),
            new BusinessClothesModel(0, "Polo negro basico", CLOTHES_TOPS, 63, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta escote negra", CLOTHES_TOPS, 64, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa roja por dentro pantalon", CLOTHES_TOPS, 65, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta cortada por abajo roja y manga negra", CLOTHES_TOPS, 66, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga blanca", CLOTHES_TOPS, 67, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera negra capucha puesta", CLOTHES_TOPS, 68, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera negra capucha quitada", CLOTHES_TOPS, 69, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta larga marron con pelito por cuello", CLOTHES_TOPS, 70, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta amarilla", CLOTHES_TOPS, 71, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina amarilla", CLOTHES_TOPS, 72, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta motivos amarillos y marron", CLOTHES_TOPS, 73, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera abierta marron motivos amarillos", CLOTHES_TOPS, 74, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera marron motivos amarillos", CLOTHES_TOPS, 75, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina camel cerrada cinturon", CLOTHES_TOPS, 76, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina gris abierta cuello levantado", CLOTHES_TOPS, 77, SEX_MALE, 50),
            new BusinessClothesModel(0, "Jersey cuadros amarillos y marron", CLOTHES_TOPS, 78, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera rojo y blanco W", CLOTHES_TOPS, 79, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta larga blanca", CLOTHES_TOPS, 80, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta larga negra", CLOTHES_TOPS, 81, SEX_MALE, 50),
            new BusinessClothesModel(0, "Polo largo gris", CLOTHES_TOPS, 82, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta larga gris rayas amarillas", CLOTHES_TOPS, 83, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera blanca letras frontal", CLOTHES_TOPS, 84, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera azul oscuro", CLOTHES_TOPS, 85, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera negra con capucha", CLOTHES_TOPS, 86, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera roja y blanca P", CLOTHES_TOPS, 87, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera roja y blanca P abierta", CLOTHES_TOPS, 88, SEX_MALE, 50),
            new BusinessClothesModel(0, "Jersey negro", CLOTHES_TOPS, 89, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera rojo oscuro y blanco", CLOTHES_TOPS, 90, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa negra larga", CLOTHES_TOPS, 92, SEX_MALE, 50),
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS", CLOTHES_TOPS, 93, SEX_MALE, 50),
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS por dentro del pantalon", CLOTHES_TOPS, 94, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa vaquera remangada por dentro del pantalon", CLOTHES_TOPS, 95, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera azul franja diagonal blanca", CLOTHES_TOPS, 96, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta marron", CLOTHES_TOPS, 97, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga marron por dentro del pantalon", CLOTHES_TOPS, 98, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta blanca abierta", CLOTHES_TOPS, 99, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta blanca escote", CLOTHES_TOPS, 100, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta rojo oscuro abierta", CLOTHES_TOPS, 101, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta rojo oscuro escote", CLOTHES_TOPS, 102, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron motivos marron claro abierta", CLOTHES_TOPS, 103, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron motivos marron claro escote", CLOTHES_TOPS, 104, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa con motivos rojos y azules", CLOTHES_TOPS, 105, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa abierta negra", CLOTHES_TOPS, 106, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta blanca bolsillos cerrada", CLOTHES_TOPS, 107, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta rojo oscuro y negro escote", CLOTHES_TOPS, 108, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta sin mangas blanca", CLOTHES_TOPS, 109, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero marron oscuro", CLOTHES_TOPS, 110, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro del pantalon", CLOTHES_TOPS, 111, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa marron claro escote", CLOTHES_TOPS, 112, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera roja blanca y negra", CLOTHES_TOPS, 113, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa escote blanca por dentro de pantalon", CLOTHES_TOPS, 114, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina marron oscuro abierta", CLOTHES_TOPS, 115, SEX_MALE, 50),
            new BusinessClothesModel(0, "Papa noel sucio", CLOTHES_TOPS, 116, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa cuadros rojo y negro", CLOTHES_TOPS, 117, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta verde y negro abierta", CLOTHES_TOPS, 118, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa rayas azul y negro escote", CLOTHES_TOPS, 119, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaquetilla sin manga azul y negro a raya", CLOTHES_TOPS, 120, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga rayas negra y blanca", CLOTHES_TOPS, 121, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 122, SEX_MALE, 50),
            new BusinessClothesModel(0, "Polo blanco", CLOTHES_TOPS, 123, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera verde oscuro cerrada", CLOTHES_TOPS, 124, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta camel", CLOTHES_TOPS, 125, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa cuadros aguamarina y negro", CLOTHES_TOPS, 126, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa cuadros aguamarina y negro abierta", CLOTHES_TOPS, 127, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta verde larga", CLOTHES_TOPS, 128, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra triangulo rojo y blanco", CLOTHES_TOPS, 129, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra triangulo rojo y blanco abierta", CLOTHES_TOPS, 130, SEX_MALE, 50),
            new BusinessClothesModel(0, "Polo LIBERTY negro", CLOTHES_TOPS, 131, SEX_MALE, 50),
            new BusinessClothesModel(0, "Polo LIBERTY negro por dentro del pantalon", CLOTHES_TOPS, 132, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa remangada marron claro por dentro de pantalon", CLOTHES_TOPS, 133, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera LIBERTY negra", CLOTHES_TOPS, 134, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa marron oscuro motivos amarillos", CLOTHES_TOPS, 135, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron oscuro larga abierta", CLOTHES_TOPS, 136, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina marron oscuro", CLOTHES_TOPS, 138, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro de pantalon", CLOTHES_TOPS, 139, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta azul oscuro larga escote", CLOTHES_TOPS, 140, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera azul rayas blancas", CLOTHES_TOPS, 141, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina negra larga abierta", CLOTHES_TOPS, 142, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera verde mangas blancas", CLOTHES_TOPS, 143, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa blanca y rayas celestes", CLOTHES_TOPS, 144, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta celeste a rayas", CLOTHES_TOPS, 145, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca normal", CLOTHES_TOPS, 146, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera azul oscuro manga blanca", CLOTHES_TOPS, 147, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera verde y blanco", CLOTHES_TOPS, 148, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa marron claro EEUU", CLOTHES_TOPS, 149, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera negra filos amarillos", CLOTHES_TOPS, 150, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra abierta letras amarilla", CLOTHES_TOPS, 151, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta rosa y negro manga larga", CLOTHES_TOPS, 152, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera marron oscuro y rojo", CLOTHES_TOPS, 153, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera marron Italia", CLOTHES_TOPS, 154, SEX_MALE, 50),
            new BusinessClothesModel(0, "CAmisa amarilla EEUU", CLOTHES_TOPS, 155, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaquetilla negra abierta sin manga", CLOTHES_TOPS, 157, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaquetilla negra cremallera sin manga", CLOTHES_TOPS, 158, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaquetilla negra botones sin manga", CLOTHES_TOPS, 159, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaquetilla negra cremallera abierta", CLOTHES_TOPS, 160, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra cuero", CLOTHES_TOPS, 161, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra cuero sin manga", CLOTHES_TOPS, 162, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa negra larga", CLOTHES_TOPS, 164, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa azul oscuro mangas serpiente blanco", CLOTHES_TOPS, 165, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 166, SEX_MALE, 50),
            new BusinessClothesModel(0, "Abrigo rojo michelin", CLOTHES_TOPS, 167, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera marron oscuro capucha", CLOTHES_TOPS, 168, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa vaquera larga abierta", CLOTHES_TOPS, 169, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa vaquera abierta larga", CLOTHES_TOPS, 170, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera negra capucha", CLOTHES_TOPS, 171, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta vaquera parches", CLOTHES_TOPS, 172, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta vaquera sin mangas parches", CLOTHES_TOPS, 173, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero parches", CLOTHES_TOPS, 174, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero sin manga parches", CLOTHES_TOPS, 175, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa negra letras rojas", CLOTHES_TOPS, 176, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa azul oscuro sin manga", CLOTHES_TOPS, 177, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga negra y amarilla", CLOTHES_TOPS, 178, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero sin manga abierta", CLOTHES_TOPS, 179, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero sin manga", CLOTHES_TOPS, 180, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta cuero abierta", CLOTHES_TOPS, 181, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera negra capucha", CLOTHES_TOPS, 182, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra y blanca a rayas", CLOTHES_TOPS, 183, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta verde oscuro larga capucha", CLOTHES_TOPS, 184, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta verde oscuro larga abierta", CLOTHES_TOPS, 185, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina negra", CLOTHES_TOPS, 187, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina camel capucha", CLOTHES_TOPS, 188, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina camel capucha abierta", CLOTHES_TOPS, 189, SEX_MALE, 50),
            new BusinessClothesModel(0, "Jersey gris rombos negros", CLOTHES_TOPS, 190, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra y verde camuflaje abierta", CLOTHES_TOPS, 191, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina gris abierta", CLOTHES_TOPS, 192, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca letras naranja", CLOTHES_TOPS, 193, SEX_MALE, 50),
            new BusinessClothesModel(0, "Navideño", CLOTHES_TOPS, 194, SEX_MALE, 50),
            new BusinessClothesModel(0, "Jersey gris con bits amarillo", CLOTHES_TOPS, 196, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camisa azul arboles blancos", CLOTHES_TOPS, 198, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera amarilla parches naranjas capucha", CLOTHES_TOPS, 200, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta negra manga larga dibujos amarillos rojos y celeste", CLOTHES_TOPS, 201, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta negra sin manga con capucha puesta", CLOTHES_TOPS, 202, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera amarilla parche naranja capucha puesta", CLOTHES_TOPS, 203, SEX_MALE, 50),
            new BusinessClothesModel(0, "Gabardina negra larga cacpucha puesta", CLOTHES_TOPS, 204, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera sin manga cuello ancho", CLOTHES_TOPS, 205, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta sin manga camuflaje azul capucha", CLOTHES_TOPS, 206, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta sin manga camuflaje azul capucha puesta", CLOTHES_TOPS, 207, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta camuflaje azul", CLOTHES_TOPS, 208, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta larga azul camuflaje", CLOTHES_TOPS, 209, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta larga azul camuflaje capucha", CLOTHES_TOPS, 210, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta larga azul camuflaje capucha puesta", CLOTHES_TOPS, 211, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta larga abierta azul camuflaje", CLOTHES_TOPS, 212, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta negra y azul camuflaje sin manga", CLOTHES_TOPS, 213, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta negra y azul camuflaje", CLOTHES_TOPS, 214, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta azul camuflaje y negra", CLOTHES_TOPS, 215, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta sin manga azul camuflaje y negra", CLOTHES_TOPS, 216, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron larga", CLOTHES_TOPS, 217, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta marron larga capucha puesta", CLOTHES_TOPS, 218, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta sin manga azul camuflaje", CLOTHES_TOPS, 219, SEX_MALE, 50),
            new BusinessClothesModel(0, "Sudadera azul mangas azul camuflaje", CLOTHES_TOPS, 220, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta manga larga azul camuflaje", CLOTHES_TOPS, 221, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta azul camuflaje", CLOTHES_TOPS, 222, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta sin manga negra cremallera", CLOTHES_TOPS, 223, SEX_MALE, 50),
            new BusinessClothesModel(0, "Chaqueta negra cremallera", CLOTHES_TOPS, 224, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta blanca y azul oscuro 98", CLOTHES_TOPS, 225, SEX_MALE, 50),
            new BusinessClothesModel(0, "Camiseta negra normal", CLOTHES_TOPS, 226, SEX_MALE, 50),
